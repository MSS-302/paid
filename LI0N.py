...
def approval():
  ...
  try:
    r1=requests.get("https://github.com/MSS-302/paid/blob/main/paid.txt").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		Main()
		...
		print(logo)
		print ("")
		print(" \033[1;32mSW4TI Toll Free BUT You Need Get Approved First\033[1;37m\n")
		print(" \033[1;32m Note :SW4TI FREE HA BHAIYO ENJOYA   \033[1;37m")
		print ("")
